...
export default function Footer(props: { lang: Dictionary }) {
    return <div className="flex flex-col w-full">
        ...
        <ScrollReveal className=" bg-test flex md:flex-row flex-col gap-5 xl:gap-18 justify-center items-center py-20 px-10">
            <h2 className="lg:text-8xl text-6xl leading-none text-herotext max-w-135 font-bold  text-center font-display">{props.lang.exchangeIdeas}</h2>
        ...
        <div className="bg-[#2e2e2e] flex flex-col md:flex-row md:justify-between justify-center items-center gap-5 md:px-32 py-10">
            <div className="flex flex-col items-center xl:flex-row xl:gap-24 gap-5">
                <div className="flex flex-row sm:gap-14 gap-8 font-bold text-lg font-heading">
